...
import { RecentTransactionsTable } from "../components/transactions/recent-transactions-table";
...
// const RecentTransactionsReal: NextPage<PropTypes> = ({ }: PropTypes) => {
...
//     useEffect(() => {
//         const getMerchantEarnings = async () => {
//             setLoading(true);

//             await fetch('/api/getMerchantEarnings', {
//                 method: 'POST',
//                 headers: {
...
//                                 return (
//                                     <div className="grid grid-cols-4 gap-4 p-3 hover:bg-slate-300/50 rounded-xl transition-all duration-150">
...
//                                         <div className={`${getStateColor(transaction.stateType)} flex mx-auto gap-2`}>
...
//                                 <div onClick={() => setExpanded({ ...expanded, [transaction.id]: !expanded[transaction.id] })}>
//                                     <div className={`grid grid-cols-4 gap-4 p-3 rounded-xl duration-150 ${expanded[transaction.id] ? 'bg-indigo-500 text-white' : 'hover:bg-slate-300/50'}`}>
//                                         <p>{transaction.trxID}</p>
//                                         <div>
//                                             <p>{(new Date(transaction.createdAt)).toUTCString()}</p>
//                                         </div>
...
//                                             <p className="text-gray-500 text-left py-1"><span className="text-black font-medium">Tx ID:</span> {transaction.id}</p>
//                                                 <p className="text-gray-500 text-left py-1"><span className="text-black font-medium">Tx Hash:</span> {transaction.txHash}</p>
//                                                 <p className="text-gray-500 text-left py-1"><span className="text-black font-medium">Tx Destination Address:</span> {transaction.address}</p>
//                                                 <p className="text-gray-500 text-left py-1"><span className="text-black font-medium">Time:</span> {(new Date(transaction.createdAt)).toUTCString()}</p>
//                                                 <p className="text-gray-500 text-left py-1"><span className="text-black font-medium">Total:</span> ${transaction.total} USD</p>
//                                             </div>
//                                         </div>
//                                     )}
//                                 </div>
...
//                                             className="w-2/3 py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">All </label>
//                                     </div>
//                                 </li>
...
//                                             className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
//                                         <label htmlFor="horizontal-list-radio-license"
//                                             className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Success </label>
//                                     </div>
//                                 </li>
//                                 <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
//                                     <div className="flex items-center pl-3">
...
//                                             className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pending</label>
//                                     </div>
//                                 </li>
//                                 <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
//                                     <div className="flex items-center pl-3">
...
//                                             className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
//                                         <label htmlFor="horizontal-list-radio-id"
//                                             className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Refunded</label>
//                                     </div>
//                                 </li>
//                                 <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
//                                     <div className="flex items-center pl-3">
...
//                                             className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Failed</label>
//                                     </div>
//                                 </li>
//                             </ul>
//                         </div>
...
const RecentTransactions: NextPage<PropTypes> = ({ }: PropTypes) => {
  const [selectedEntity, setSelectedEntity] = useContext(SelectedEntityContext)
    ...
    return ( 
      <>
          <div className="w-full h-screen px-4 sm:px-6 grid md:place-items-center lg:px-8 my-auto">
